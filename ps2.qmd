...
rating_summary_d = rating_hyp_long_d %>%
  ...
  summarise(MeanRating=mean(Score, na.rm=T))
...
#summary(model)
#I was receiving the error "Error in eval(predvars, data, env) for this piece of code that was here : object 'Rating' not found" so I commented it out to be able to render it
```
